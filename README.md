...
![Skills](https://skills.syvixor.com/api/icons?i=js,nodejs,ts,sass,vue,react,express)

### Tools I use

![Skills](https://skills.syvixor.com/api/icons?i=vscode,vite,git,pnpm,chatgpt,tailwind,,vercel)
